...
if __name__ == '__main__':
    ...
    if NEPTUNE:
        tweet_classifier = TweetClassifierNeptune(max_nr_words=MAX_WORDS,
        ...
        tweet_classifier = TweetClassifier(max_nr_words=MAX_WORDS,
                                   sequence_length=MAX_SEQ_LEN,
                                   embedding_dim=EMBEDDING_DIM,
                                   path_to_word_embeddings=MODEL_FILEPATH,
                                   word_index = tweet_prep.tokenizer.word_index,
    ...
    tweet_classifier.train((X_train, y_train), (X_test, y_test), batch_size=128, epochs=10)
