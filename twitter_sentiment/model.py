...
class TweetClassifier(object):
    def __init__(self, max_nr_words, sequence_length, embedding_dim, path_to_word_embeddings, 
...
class TweetClassifierNeptune(TweetClassifier):
    def __init__(self, max_nr_words, sequence_length, embedding_dim, 
                 path_to_word_embeddings, word_index, classes, model_save_filepath):
        super(TweetClassifierNeptune, self).__init__(max_nr_words, sequence_length, 
